...
public class TestInterface {
	...
	public static void main(String[] args) {
		try {
			...
			((Employee) e3).setId(3);
			((Employee) e3).setFirstName("KATHUNGU");
			((Employee) e3).setLastName("AKEMANI");
			((Employee) e3).setCnss("23LIAGE1070766");
			e3.add();
			System.out.println("Employe 3 Inserer avec succes");

			Person e4 = new Employee();
			((Employee) e4).setId(4);
			((Employee) e4).setFirstName("KATUNGU");
			((Employee) e4).setLastName("KAVUNO");
			((Employee) e4).setCnss("23LIAGELJ1070639"); 
			e4.add();
			...
			et10.add();
                        ...
                        et16.add();
                        System.out.println("L'etudiant 116 inserer avec succes!");
